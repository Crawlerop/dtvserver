            ...
            */
            ...
            if (Object.keys(params.dtv_udp_out).indexOf(dtv_key) !== -1) {
                if (params.use_protocol === "tcp") {
                    ...
                    tsp_args.push(`tsp -P zap ${channel.id} | ${params.ffmpeg} -copyts -i - -vcodec copy -acodec copy -copyinkf -loglevel error -f mpegts tcp://${params.dtv_udp_out[dtv_key]}`)
                    ...
                    tsp_args.push(`tsp -P zap ${channel.id} | ${params.ffmpeg} -copyts -i - -vcodec copy -acodec copy -copyinkf -loglevel error -f mpegts -flush_packets 0 udp://${params.dtv_udp_out[dtv_key]}?pkt_size=188`)
                } else {
