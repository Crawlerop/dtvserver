    ...
    */
    ...
    app.post("/api/get_channels_by_frequency", async (req, res) => {
        ...
        try {
            ...
            const probe_streams = JSON.parse((await check_output(config.ffmpeg.replace(/mpeg/g, "probe"), "-loglevel quiet -print_format json -show_error -probesize 64M -show_format -show_programs -".split(" "), 0, dtv_chunk)).toString("utf-8")).programs
